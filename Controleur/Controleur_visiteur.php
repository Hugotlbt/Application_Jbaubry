                    ...
                    if ($_REQUEST["password"] == $utilisateur["motDePasse"]) {
                        ...
                        switch ($utilisateur["idCategorie_utilisateur"]) {
                            ...
                            case 4:
                                ...
                                break;
                            case 5:
                                $_SESSION["typeConnexionBack"] = "commercial"; //Champ inutile, mais bien pour voir ce qu'il se passe avec des étudiants !
                                $Vue->setMenu(new \App\Vue\Vue_Menu_Administration($_SESSION["typeConnexionBack"]));
                                break;
                        }
